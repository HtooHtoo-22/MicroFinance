...
@Component({
  ...
  templateUrl: './sme-laon-register.component.html',
  styleUrl: './sme-laon-register.component.css'
})
export class SmeLaonRegisterComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.smeLoanForm.valid) {
      ...
      // Call your API to save the SME Loan data
    } else {
