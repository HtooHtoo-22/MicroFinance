...
@Component({
  selector: 'app-loan-metrics',
  standalone: false,
  templateUrl: './loan-metrics.component.html',
  styleUrl: './loan-metrics.component.css'
})
export class LoanMetricsComponent implements OnInit {
