...
export class AuthService {
    ...
    return this.http.post<any>(
      ...
      tap(response => {
        if (response.access_token) {
          ...
          this.storageService.setItem('currentAccountId', response.currentAccountId);
  ...
  getCurrentUserCurrentAccountId(): string | null {
    return this.storageService.getItem('currentAccountId'); // Retrieve current account ID
  }
