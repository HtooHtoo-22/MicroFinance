...
public interface CIFService {
     CIFDTO createCIF(CIFDTO cifDTO, MultipartFile frontNRC, MultipartFile backNRC, MultipartFile userPhoto) throws IOException;
     ...
     CIFDTO getCifById(Integer id);  // ✅ Add this method
